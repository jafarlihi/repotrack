...
repotrack display comment count of your active PRs and issues on an ncurses display and keeps it updated.
...
`REPOTRACK_USERNAME` is the username for the assignee whose PRs and issues will be tracked.
